...
FEATURE_DIR=output/wdata
MODEL_ROOT_DIR=output/models

# path to SAR_orientations.txt
SAR_ORIENTATION_PATH=dataset/SAR_orientations.txt

# compute_mean_std.py
IMAGE_MEAN_STD_DIR=dataset/image_mean_std

# # geojson_to_mask.py
BUILDING_MASK_DIR=dataset/masks
# BUILDING_BOUNDARY_WIDTH=6
# BUILDING_MIN_AREA=20

# split_dataset.py
DATA_SPLIT_DIR=dataset/split
DATA_SPLIT_NUM=5
...
# CONFIG_A_1=configs/unet-scse_efficientnet-b7_v_03.yml
...
TRAIN_STDOUT_DIR=${FEATURE_DIR}/stdout/train
